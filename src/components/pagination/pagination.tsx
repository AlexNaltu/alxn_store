...
export const Pagination = (props: PaginationProps) => {
  ...
  return (
    <div className="flex space-x-2 text-black sm:space-x-6">
      <Link
        className={cn(
      ...
      >
        {pages.map((p, i) => (
          <Link
            key={p}
            className={cn(
              "relative inline-flex items-center border border-gray-300 px-4 py-2 text-xs font-medium hover:bg-gray-50",
      ...
      <Link
        className={cn(
          "rounded-md border border-gray-300 px-3 py-2 text-xs font-medium hover:bg-gray-50",
